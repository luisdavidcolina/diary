// Tasas del día: BCV (oficial) y Binance P2P USDT/VES (promedio calculado desde la fuente).
// Se ejecuta en el servidor (Vercel) para evitar CORS y las caídas de las APIs de terceros.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Cache en el edge de Vercel: 30 min, sirviendo el valor viejo mientras revalida.
